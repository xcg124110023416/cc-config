...
| 用途 | 路径 |
|---|---|
| 跨会话记忆(全局) | `${CLAUDE_CONFIG_DIR:-$HOME/.claude}/projects/<encoded-project-path>/memory/` |
| 记忆索引文件 | `${CLAUDE_CONFIG_DIR:-$HOME/.claude}/projects/<...>/memory/MEMORY.md` |
| 全局指令 | `${CLAUDE_CONFIG_DIR:-$HOME/.claude}/CLAUDE.md` |
| 项目级指令 | 项目根 `CLAUDE.md`(可层级嵌套) |
| Skills 目录 | `${CLAUDE_CONFIG_DIR:-$HOME/.claude}/skills/<name>/SKILL.md` |
